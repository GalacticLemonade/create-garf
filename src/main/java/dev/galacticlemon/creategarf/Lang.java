...
import dev.galacticlemon.creategarf.CreateGarf;
...
public class Lang {
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(CreateGarf.MODID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(CreateGarf.MODID);
    }
